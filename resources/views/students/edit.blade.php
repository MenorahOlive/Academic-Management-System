        ...
        @method('PUT')
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Phone:</strong>
                    <input type="tel" name="phone" value="{{ $student->phone }}" class="form-control" placeholder="phone">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Parents Name:</strong>
                    <input type="text" name="parentsname" value="{{ $student->parent_name }}" class="form-control" placeholder="parents name">
                </div>
            </div>
