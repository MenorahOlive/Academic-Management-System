...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="{{url('/students/timetable')}}" class="active">
    ...
    <div class="section">
        ...
        <body>
            ...
            <h1 class="heading" style="margin-left: 180px;">View Timetable</h1>
                ...
                <table style="margin-left: 200px;">
                    ...
                    <thead>
                        ...
                        <th colspan="2">12:00-2:00</th>
                        <th colspan="2">2:00-4:00</th>
                        <th colspan="2">4:00-:6:00</th>
                    </thead>
